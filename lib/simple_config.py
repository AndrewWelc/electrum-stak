...
FEERATE_FALLBACK_STATIC_FEE = 2500
FEERATE_DEFAULT_RELAY = 1000
FEERATE_STATIC_VALUES = [2500, 5000, 10000, 20000, 30000, 50000, 70000, 100000, 150000, 200000, 300000]
...
class SimpleConfig(PrintError):
    ...
    def get_wallet_path(self):
        ...
        old_path = os.path.join(self.path, "electrum-stakdat")
