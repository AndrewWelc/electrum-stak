...
for repo in electrum-stak electrum-locale electrum-stak-icons; do
	...
	URL=https://lab.straks.co/straks/$repo.git
...
# $VERSION could be passed to the electrum-stak.nsi script, but this would require some rewriting in the script itself.
