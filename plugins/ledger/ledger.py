...
from electrum_stak import bitcoin
from electrum_stak.bitcoin import TYPE_ADDRESS, int_to_hex, var_int
from electrum_stak.i18n import _
from electrum_stak.plugins import BasePlugin
from electrum_stak.keystore import Hardware_KeyStore
from electrum_stak.transaction import Transaction
from ..hw_wallet import HW_PluginBase
from electrum_stak.util import print_error, is_verbose, bfh, bh2u, versiontuple
...
MSG_NEEDS_FW_UPDATE_SEGWIT = _('Firmware version (or "STRAKS" app) too old for Segwit support. Please update at') + \
                      ' https://www.ledgerwallet.com'
        ...
        if not self.preflightDone:
            try:
                ...
                if (e.sw == 0x6d00 or e.sw == 0x6700):
                    raise Exception(_("Device not in STRAKS mode")) from e
                raise e
