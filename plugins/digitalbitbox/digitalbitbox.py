# ----------------------------------------------------------------------------------
# electrum_stak.plugin for the Digital Bitbox hardware wallet by Shift Devices AG
# digitalbitbox.com
#

try:
    import electrum_stak
    from electrum_stak.bitcoin import TYPE_ADDRESS, push_script, var_int, msg_magic, Hash, verify_message, pubkey_from_signature, point_to_ser, public_key_to_p2pkh, EncodeAES, DecodeAES, MyVerifyingKey
    from electrum_stak.bitcoin import serialize_xpub, deserialize_xpub
    from electrum_stak.import constants
    from electrum_stak.transaction import Transaction
    from electrum_stak.i18n import _
    from electrum_stak.keystore import Hardware_KeyStore
    from ..hw_wallet import HW_PluginBase
    from electrum_stak.util import print_error, to_string, UserCancelled
    from electrum_stak.base_wizard import ScriptTypeNotSupported, HWD_SETUP_NEW_WALLET
