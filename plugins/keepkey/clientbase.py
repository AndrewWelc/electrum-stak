...
from electrum_stak.util import PrintError, UserCancelled
from electrum_stak.keystore import bip39_normalize_passphrase
from electrum_stak.bitcoin import serialize_xpub
    ...
    def callback_PassphraseRequest(self, req):
        if self.creating_wallet:
            msg = _("Enter a passphrase to generate this wallet.  Each time "
                    ...
                    "access the STRAKS in the wallet.").format(self.device)
        else:
