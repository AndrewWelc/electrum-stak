...
class LabelsPlugin(BasePlugin):
    ...
    def __init__(self, parent, config, name):
        ...
        self.target_host = 'labels-electrum.straks.tech'
        self.wallets = {}

    def encode(self, wallet, msg):
        password, iv, wallet_id = self.wallets[wallet]
        encrypted = electrum_stak.bitcoin.aes_encrypt_with_iv(password, iv,
                                                         msg.encode('utf8'))
    ...
    def decode(self, wallet, message):
        ...
        decrypted = electrum_stak.bitcoin.aes_decrypt_with_iv(password, iv, decoded)
