...
from electrum_stak.util import UserCancelled, InvalidPassword
from electrum_stak.base_wizard import BaseWizard, HWD_SETUP_DECRYPT_WALLET
...
class InstallWizard(QDialog, MessageBoxMixin, BaseWizard):
    ...
    def __init__(self, config, app, plugins, storage):
        ...
        self.setWindowTitle('Electrum-STAK  -  ' + _('Install Wizard'))
        self.app = app
        self.config = config
    ...
    def run_and_get_wallet(self, get_wallet_from_daemon):
        ...
        self.set_layout(vbox, title=_('Electrum-STAK wallet'))
