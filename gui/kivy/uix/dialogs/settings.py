...
from electrum_stak import coinchooser
from electrum_stak.util import fee_levels
...
<SettingsDialog@Popup>
    id: settings
    title: _('Electrum-STAK Settings')
    disable_pin: False
        ...
        ScrollView:
            GridLayout:
                ...
                SettingsItem:
                    ...
                    description: _("Base unit for STRAKS amounts.")
